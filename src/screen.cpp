...
namespace system::io
{
    entity::Screen::Screen() : graphicMemory((uint32_t *)system::memory::phyicalToVirtualAddr((void *)system::boot::getBootInfo()->graphicInfo.FrameBufferBase)),
    ...
    void entity::Screen::drawPixel(uint32_t x, uint32_t y, system::media::entity::Color color)
    {
